...
@section('content')
    <h2 class="text-3xl font-bold text-green-900">Add a New Inventory Item</h2>
    ...
    <!-- Creation Form -->
    <!-- ========================= -->
    <form action="{{ route('inventories.store') }}" method="POST" class="mt-6">
        @csrf
            ...
            <div class="mt-2">
                ...
                <div class="flex flex-wrap gap-12 mt-2">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <label id="common_name_label" class="block text-black">-</label>
        ...
        <div class="flex mt-12 justify-center max-w-xl">
            <x-button-admin type="submit" value="Add Inventory" />
        </div>
    ...
    @push('scripts')
        <script>
            ...
            const treeData = @json($trees);

        </script>
        <script src="{{ asset('js/table_helpers.js') }}"></script>
        <script src="{{ asset('js/menu_top/inventories/create.js') }}"></script>
