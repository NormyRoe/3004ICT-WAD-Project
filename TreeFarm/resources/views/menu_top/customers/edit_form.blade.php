...
@section('content')
    <h2 class="text-3xl font-bold text-green-900">Update an existing Customer</h2>
    ...
    <form action="{{ route('customers.update', $customer->id) }}" method="POST" class="mt-6">
            ...
            <div class="flex flex-col space-y-4">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="surname" 
                        class="border border-yellow-800 rounded p-2 w-64"
                        value="{{ old('surname', $customer->last_name) }}"
                        required
                    >
                </div>
            ...
            <div class="flex flex-col space-y-4">
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="border border-yellow-800 rounded p-2 w-64"
                        value="{{ old('street_address_1', $customer->street_address_1) }}"
                        required
                    >
                </div>
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="border border-yellow-800 rounded p-2 w-64"
                        value="{{ old('street_address_2', $customer->street_address_2) }}"
                    >
                </div>
        ...
        <div class="flex mt-12 justify-center max-w-xl">
            <x-button-admin type="submit" value="Update Customer" />
        </div>
