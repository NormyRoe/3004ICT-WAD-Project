...
@section('content')
    <h2 class="text-3xl font-bold text-green-900">Add a New Area</h2>
    ...
    <!-- Creation Form -->
    <!-- ========================= -->
    <form action="{{ route('areas.store') }}" method="POST" class="mt-6">
        @csrf
        ...
        <!-- Button  -->
        <x-button-admin type="submit" value="Add Area" />
