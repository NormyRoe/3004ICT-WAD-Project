...
@section('content')
    <h2 class="text-3xl font-bold text-green-900">Add a New Price</h2>
    ...
    <!-- Creation Form -->
    <!-- ========================= -->
    <form action="{{ route('prices.store') }}" method="POST" class="mt-6">
        @csrf
        ...
        <div class="flex mt-12 justify-center max-w-xl">
            <x-button-admin type="submit" value="Add Price" />
        </div>
