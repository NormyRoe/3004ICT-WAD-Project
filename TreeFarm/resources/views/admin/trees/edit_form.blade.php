...
@section('content')
    <h2 class="text-3xl font-bold text-green-900">Update an existing Tree</h2>
    ...
    <!-- Update Form -->
    <!-- ========================= -->
    <form method="POST" action="{{ route('trees.update', $tree->id) }}" class="mt-6">
        @csrf
        {{ method_field('PUT') }}
        <div class="mb-4">
            ...
            <input 
                ...
                value="{{ old('plant_id', $tree->plant_id) }}"
                required
            >
            ...
            >
                ...
                @foreach ($tree_types as $tree_type)
                    <option 
                        value="{{ $tree_type->id }}"
                        {{ old('tree_type_id', $tree->tree_type_id) == $tree_type->id ? 'selected' : '' }}
                    >
                        {{ $tree_type->name }}
                    </option>
                @endforeach
            ...
            <input 
                ...
                name="botanical_name" 
                class="border border-yellow-800 rounded p-2 w-64"
                value="{{ old('botanical_name', $tree->botanical_name) }}"
                required
            >
            ...
            <input 
                ...
                name="common_name" 
                class="border border-yellow-800 rounded p-2 w-64"
                value="{{ old('common_name', $tree->common_name) }}"
                required
            >
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-2">
                        <div class="text-center">
                            ...
                            <input 
                                ...
                                name="height_min" 
                                class="border border-yellow-800 rounded p-2 w-64"
                                value="{{ old('height_min', $tree->mature_height_min) }}"
                            >
                        </div>
                        <div class="text-center">
                            ...
                            <input 
                                ...
                                name="height_max" 
                                class="border border-yellow-800 rounded p-2 w-64"
                                value="{{ old('height_max', $tree->mature_height_max) }}"
                                required
                            >
                        </div>
                    </div>                
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-2">
                        <div class="text-center">
                            ...
                            <input 
                                ...
                                name="width_min" 
                                class="border border-yellow-800 rounded p-2 w-64"
                                value="{{ old('width_min', $tree->mature_width_min) }}"
                            >
                        </div>
                        <div class="text-center">
                            <label class="block text-green-900 font-semibold">Max</label>
                            <input 
                                ...
                                name="width_max" 
                                class="border border-yellow-800 rounded p-2 w-64"
                                value="{{ old('width_max', $tree->mature_width_max) }}"
                                required
                            >
                        </div>
                    </div>                
        ...
        <!-- Button  -->
        <x-button-admin type="submit" value="Update Tree" />
